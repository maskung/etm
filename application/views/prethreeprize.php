    ...
    <section class="intro">
		...
		<div class="center-content">
			...
			<div class="intro-content text-center">	
				...
				<!-- ==== Main Heading ==== -->												
				<h1 class="intro-title">การประกาศรายชื่อผู้ได้รับรางวัลจากการ<span class="obak">เฝ้าเดี่ยว</span>ประจำไตรมาส</h1>
				...
				<div class="intro-subtitle">
					<p style="font-size: 2.5vw">จำนวนผู้มีสิทธิ์ได้รับรางวัลจากการเฝ้าเดี่ยวครบทุกวันประจำไตรมาส</p>
					...
					<div class="col-sm-offset-1 col-sm-2 col-xs-2">
							<table class="table" style="font-size: 1.8vw">
								...
								<?php } ?>
								<tr style="font-size:2.5vw"><td class="text-left">รวม</td><td class="text-right"><?php echo $total; ?> คน</td></tr>
								</tbody>
							</table>
					</div>
		...
		<div class="container-bottom-content">					
			<!-- ==== Social Links ==== -->
			<div class="social">
				<a href="<?php echo base_url(); ?>home/fortunethree"><i class="fa fa fa-smile-o fa-2x fa-social"></i></a>
				<?php if (!empty($peoplewons)) { ?>
				<a href="<?php echo base_url(); ?>home/clearthree"><i class="fa fa fa fa-times fa-2x fa-social"></i></a>
				<?php } ?>
