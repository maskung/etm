    ...
    <section class="intro">
		...
		<div class="center-content">
			...
			<div class="intro-content text-center">
				<!-- Logo -->
				<div class="logo">
					<h2 class="text-logo">ETM</h2>
				</div><!-- /End logo -->
				<!-- ==== Main Heading ==== -->
				<h1 class="intro-title">ระบบ<span class="obak">เรียกนักเรียน</span></h1>
...
$(function(){
      $("#exampleInputEmail2").autocomplete({
      source: function(request, response) {
        $.ajax({
          ...
          url: "<?php echo site_url();?>/home/search_jquery_autocomplete",
          dataType: "jsonp",
          data: {
